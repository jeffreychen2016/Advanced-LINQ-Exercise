...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        {
            var expected = PracticeData[0].Students.OrderBy(student => student.Birthday)/*FILL IN LINQ EXPRESSION*/.ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[0].Students.OrderByDescending(student => student.Birthday)/*FILL IN LINQ EXPRESSION*/.ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[2].JuniorInstructors.OrderBy(instructor => instructor.LastName)/*FILL IN LINQ EXPRESSION*/.ToList();
