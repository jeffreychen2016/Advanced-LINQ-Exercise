...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(cohort => cohort.Active)/*FILL IN LINQ EXPRESSION*/.ToList(); 
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(cohort => cohort.PrimaryInstructor.FirstName == "Jurnell")/*FILL IN LINQ EXPRESSION*/.ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(cohort => cohort.JuniorInstructors.Count == 3)/*FILL IN LINQ EXPRESSION*/.ToList();
